            ...
            <ImageBackground source={Images.splashBg} style={styles.bg} resizeMode="cover">
                ...
                <View style={[styles.sheet, { marginBottom: TAB_GAP, height: height * 0.73 }]}>
                    ...
                    <View style={styles.topRow}>
                        ...
                        <Text style={styles.topTitle}>Reel</Text>
                    ...
                    <View style={styles.videoBox}>
                        <View style={styles.videoInner}>
                            <Pressable style={styles.playBtn}>
                                <Icon name="play" size={44} color="#777" />
                            </Pressable>
                        </View>
                    ...
                    {/* Share button */}
                    <Pressable style={styles.shareBtn} onPress={() => navigation.navigate("ReadyToShare")}>
...
const styles = StyleSheet.create({
    ...
    shareText: { color: "#fff", fontSize: 20, fontFamily: "Montserrat-Bold" },
});
